...
MenuController::MenuController(Vortex * gameEngine) : SubController(gameEngine){
	...
	guiObjects.push_back(new VortexButton(centerX - (buttonWidth / 2), centerY - (buttonHeight / 2), buttonWidth, buttonHeight, "Graphics/button.png", "Vi er i menu!", gameEngine));
}
